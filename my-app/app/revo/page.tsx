...
export default function Revo() {
    return (
        <div className="bg-white">
            <h1 className=" flex justify-center text-black underline text-xl font-bold "> Toyota Revo 2024 Price in Pakistan,Images,Reviews & Specs</h1>
            ...
            <div className="flex justify-center mt-[0.5cm] ">
                ...
                <div className="flex mx-[0.4cm]">
                    ...
                    <h1 className="text-xs ml-[0.1cm]"> 6 Km per ltr</h1>
                </div>
                <div className="flex mx-[0.4cm]">
                    <h1 className="font-bold text-xs font-serif mx-1">Transmission</h1>
                    <h1 className="text-xs ml-[0.1cm]"> Manual </h1>
                </div>
                <div className="flex mx-[0.4cm]">
                    <h1 className="font-bold text-xs font-serif mx-1">Fuel Type</h1>
                    <h1 className="text-xs ml-[0.1cm]"> Diesel </h1>
                </div>
