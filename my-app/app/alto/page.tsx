...
export default function Alto() {
    return (
        <div className="bg-white">
            <h1 className=" flex justify-center text-black underline text-xl font-bold "> Suzuki Alto 2024 Price in Pakistan,Images,Reviews & Specs</h1>
            ...
            <div className="flex justify-center mx-[0.4cm] ">
                ...
                <div className="flex mx-[0.4cm]">
                    ...
                    <h1 className="text-xs ml-[0.1cm]"> 600 CC</h1>
                </div>
                <div className="flex mx-[0.4cm]">
                    <h1 className="font-bold text-xs font-serif mx-1">Condition</h1>
                    <h1 className="text-xs ml-[0.1cm]">8.5 / 10 </h1>
                </div>
                <div className="flex mx-[0.4cm]">
                    <h1 className="font-bold text-xs font-serif mx-1">Driven</h1>
                    <h1 className="text-xs ml-[0.1cm]"> 6500 Km</h1>
                </div>
                <div className="flex mx-[0.4cm]">
            ...
            <div className="flex justify-center mt-[0.5cm] ">
                ...
                <div className="flex mx-[0.4cm]">
                    ...
                    <h1 className="text-xs ml-[0.1cm]"> 16 Km per ltr</h1>
                </div>
                <div className="flex mx-[0.4cm]">
                ...
                <div className="flex mx-[0.4cm]">
                    ...
                    <h1 className="text-xs ml-[0.1cm]"> Octane </h1>
                </div>
